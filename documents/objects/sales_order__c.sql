/*
 ...
 Date: 03/12/2019 08:43:45
*/


-- ----------------------------
-- Table structure for sales_order__c
-- ----------------------------
DROP TABLE IF EXISTS "prod"."sales_order__c";
CREATE TABLE "prod"."sales_order__c" (
...
;
COMMENT ON COLUMN "prod"."sales_order__c"."status" IS '1: oke, 0: fail (job)';

-- ----------------------------
-- Primary Key structure for table sales_order__c
-- ----------------------------
ALTER TABLE "prod"."sales_order__c" ADD CONSTRAINT "sales_order__c_pkey" PRIMARY KEY ("id");
