...
const table_sql = process.env.PG_SCHEMA+'.gw_trackings';
            ...
            if(v){
                switch (k) {
                    case 'id':
                        ...
                        break;
                    case 'operation':
                        conditions.push('operation = ' + sqlstring.escape(v));
                        break;
                    case 'merchant':
                    ...
                    case 'object':
                        ...
                        break;
                    case 'sf_job_id':
                        conditions.push('sf_job_id = ' + sqlstring.escape(v));
                        break;
                    case 'status':
